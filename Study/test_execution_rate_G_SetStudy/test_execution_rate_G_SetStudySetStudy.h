...
#ifndef test_execution_rate_G_SetStudySetSTUDY_H_
#define test_execution_rate_G_SetStudySetSTUDY_H_
...
class test_execution_rate_G_SetStudySetStudy : public BaseStudyClass {
public:

test_execution_rate_G_SetStudySetStudy();
~test_execution_rate_G_SetStudySetStudy();
